...
const warningEvents: WarningEvent[] = [
  ...
  { id: 'w2', outletId: 'o2', outletCode: 'GAS-E1-001', enterpriseName: '华泰化工有限公司', level: 'orange', type: 'exceed', typeName: '浓度超标', pollutantName: 'VOCs', exceedValue: 24.8, limitValue: 20, unit: 'mg/m³', triggerTime: '2026-06-21 07:30:00', status: 'processing', handler: '王执法', description: 'VOCs小时均值超标，达24.8mg/m³' },
  { id: 'w3', outletId: 'o3', outletCode: 'WS-E2-001', enterpriseName: '鑫源印染集团', level: 'yellow', type: 'facility_stop', typeName: '设施停运', pollutantName: '-', exceedValue: 0, limitValue: 0, unit: '', triggerTime: '2026-06-21 06:45:00', status: 'resolved', handler: '李执法', description: '生产在线但治污设施加药泵停运，已恢复' },
  ...
  { id: 'w5', outletId: 'o1', outletCode: 'WS-E1-001', enterpriseName: '华泰化工有限公司', level: 'orange', type: 'data_anomaly', typeName: '数据异常', pollutantName: 'pH', exceedValue: 10.2, limitValue: 9, unit: '', triggerTime: '2026-06-21 04:10:00', status: 'processing', handler: '张执法', description: 'pH值异常偏高，疑似排放碱性废水' },
  { id: 'w6', outletId: 'o4', outletCode: 'GAS-E3-001', enterpriseName: '恒通钢铁厂', level: 'yellow', type: 'fraud_suspect', typeName: '疑似造假', pollutantName: 'SO₂', exceedValue: 0, limitValue: 100, unit: 'mg/m³', triggerTime: '2026-06-20 22:00:00', status: 'dispatched', description: 'SO₂数据长时间恒定在5mg/m³，与生产工况不符' },
  ...
  { id: 'w8', outletId: 'o7', outletCode: 'WS-E6-001', enterpriseName: '天成制药有限公司', level: 'yellow', type: 'facility_stop', typeName: '设施停运', pollutantName: '-', exceedValue: 0, limitValue: 0, unit: '', triggerTime: '2026-06-21 03:30:00', status: 'resolved', handler: '赵执法', description: '生化池曝气风机停运2小时，已恢复' },
]

const enforcementTasks: EnforcementTask[] = [
  { id: 'f1', warningId: 'w1', enterpriseName: '华泰化工有限公司', outletCode: 'WS-E1-001', enforcerName: '王执法', type: 'check', typeName: '现场检查', status: 'assigned', assignTime: '2026-06-21 08:20:00', description: 'COD超标现场核查' },
  { id: 'f2', warningId: 'w2', enterpriseName: '华泰化工有限公司', outletCode: 'GAS-E1-001', enforcerName: '李执法', type: 'check', typeName: '现场检查', status: 'in_progress', assignTime: '2026-06-21 07:35:00', description: 'VOCs超标现场检查' },
  { id: 'f3', warningId: 'w4', enterpriseName: '绿洲纸业有限公司', outletCode: 'WS-E4-001', enforcerName: '张执法', type: 'rectify', typeName: '整改督办', status: 'assigned', assignTime: '2026-06-21 05:25:00', description: 'COD严重超标整改' },
  { id: 'f4', warningId: 'w3', enterpriseName: '鑫源印染集团', outletCode: 'WS-E2-001', enforcerName: '李执法', type: 'review', typeName: '复核销号', status: 'completed', assignTime: '2026-06-21 06:50:00', completeTime: '2026-06-21 10:30:00', description: '设施停运核查已完成' },
  { id: 'f5', warningId: 'w6', enterpriseName: '恒通钢铁厂', outletCode: 'GAS-E3-001', enforcerName: '赵执法', type: 'check', typeName: '现场检查', status: 'in_progress', assignTime: '2026-06-20 22:05:00', description: '疑似数据造假现场核查' },
  { id: 'f6', warningId: 'w7', enterpriseName: '永利建材有限公司', outletCode: 'GAS-E8-001', enforcerName: '王执法', type: 'rectify', typeName: '整改督办', status: 'assigned', assignTime: '2026-06-21 09:05:00', description: '烟尘超标整改' },
]
