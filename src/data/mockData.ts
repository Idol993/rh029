...
const enforcementTasks: EnforcementTask[] = [
  { id: 'f1', warningId: 'w1', enterpriseName: '华泰化工有限公司', outletCode: 'WS-E1-001', enforcerName: '王执法', type: 'check', typeName: '现场检查', status: 'assigned', assignTime: '2026-06-21 08:20:00', description: 'COD超标现场核查', evidenceFiles: [], rectifyStep: 0, rectifyStepTimes: ['2026-06-21 08:20:00'] },
  { id: 'f2', warningId: 'w2', enterpriseName: '华泰化工有限公司', outletCode: 'GAS-E1-001', enforcerName: '李执法', type: 'check', typeName: '现场检查', status: 'in_progress', assignTime: '2026-06-21 07:35:00', description: 'VOCs超标现场检查', evidenceFiles: [], rectifyStep: 0, rectifyStepTimes: ['2026-06-21 07:35:00'] },
  { id: 'f3', warningId: 'w4', enterpriseName: '绿洲纸业有限公司', outletCode: 'WS-E4-001', enforcerName: '张执法', type: 'rectify', typeName: '整改督办', status: 'assigned', assignTime: '2026-06-21 05:25:00', description: 'COD严重超标整改', evidenceFiles: [], rectifyStep: 0, rectifyStepTimes: ['2026-06-21 05:25:00'] },
  { id: 'f4', warningId: 'w3', enterpriseName: '鑫源印染集团', outletCode: 'WS-E2-001', enforcerName: '李执法', type: 'review', typeName: '复核销号', status: 'completed', assignTime: '2026-06-21 06:50:00', completeTime: '2026-06-21 10:30:00', description: '设施停运核查已完成', evidenceFiles: [], rectifyStep: 3, rectifyStepTimes: ['2026-06-21 06:50:00', '2026-06-21 07:00:00', '2026-06-21 10:00:00', '2026-06-21 10:30:00'] },
  { id: 'f5', warningId: 'w6', enterpriseName: '恒通钢铁厂', outletCode: 'GAS-E3-001', enforcerName: '赵执法', type: 'check', typeName: '现场检查', status: 'in_progress', assignTime: '2026-06-20 22:05:00', description: '疑似数据造假现场核查', evidenceFiles: [], rectifyStep: 0, rectifyStepTimes: ['2026-06-20 22:05:00'] },
  { id: 'f6', warningId: 'w7', enterpriseName: '永利建材有限公司', outletCode: 'GAS-E8-001', enforcerName: '王执法', type: 'rectify', typeName: '整改督办', status: 'assigned', assignTime: '2026-06-21 09:05:00', description: '烟尘超标整改', evidenceFiles: [], rectifyStep: 0, rectifyStepTimes: ['2026-06-21 09:05:00'] },
]
